...
func (x *ScopeNew) Pos() token.Pos { return x.Lparen }
func (x *ScopeNew) End() token.Pos { return x.Rparen }
...
func (x *MemberAccess) End() token.Pos { return x.RparenPos }
...
func (x *ReceiverInit) Pos() token.Pos  { return x.Literal.Pos() }
func (x *ReceiverInit) End() token.Pos  { return x.Expr.Pos() }
